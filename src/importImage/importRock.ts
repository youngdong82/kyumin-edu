...
import r139 from "../asset/test/rock/석보139.png";
import r140 from "../asset/test/rock/석보140.png";
...
export const rockImages: ImageData[] = [
  ...
  { id: "r_139", imageUrl: r139, width: 0, height: 0 },
  { id: "r_140", imageUrl: r140, width: 0, height: 0 },
  { id: "r_141", imageUrl: r141, width: 0, height: 0 },
